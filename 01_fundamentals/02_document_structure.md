...
The default `\maketitle` command produces a standard, fixed-format title block. For a more unique layout, additional tools are necessary.
...
Once the preamble is set, the main content is placed within a dedicated block and organized into a logical hierarchy using a series of sectioning commands.
